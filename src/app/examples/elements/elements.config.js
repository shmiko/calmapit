(function() {
    ...
    function moduleConfig($translatePartialLoaderProvider, $stateProvider, triMenuProvider) {
        ...
        $stateProvider
        .state('calmapit.admin-default.elements-buttons', {
            url: '/elements/buttons',
            templateUrl: 'app/examples/elements/buttons.tmpl.html',
            controller: 'ButtonsController',
            controllerAs: 'vm'
        })
        .state('calmapit.admin-default.elements-icons', {
            url: '/elements/icons',
        ...
        .state('calmapit.admin-default.elements-chips', {
            url: '/elements/chips',
        ...
        .state('calmapit.admin-default.elements-cards', {
            url: '/elements/cards',
